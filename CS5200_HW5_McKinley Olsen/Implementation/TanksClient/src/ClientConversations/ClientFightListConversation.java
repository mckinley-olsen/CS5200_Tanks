...
public class ClientFightListConversation extends FightListConversation
{
    ...
    private void start()
    {
        ...
        this.getLogger().debug("ClientFightListConversation start\n\tstarted FightList conversation");
    }
    private void sendRequest(FightListRequest request)
    {
        ...
        this.getLogger().debug("ClientFightListConversation sendShellRequest\n\tsent FightList request");
        System.out.println("Sending FightList request");
    }
    ...
    private void processReply()
    {
        if(this.hasProcessedReply==false)
        {
            ...
            Conversation.addStatus("Received FightListReply");
        }
    }
